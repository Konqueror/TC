...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        Racket playerRacket;
        //2. Make the sleep time a field in the Engine and implement a constructor, which takes it as an additional parameter.
        int sleepTime;
        ...
        private void AddRacket(GameObject obj)
        {
            ...
            this.allObjects.RemoveAll(x => x is Racket); // Task 3 here
            this.AddStaticObject(obj);
        }
